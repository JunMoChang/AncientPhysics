...
- 有很多注释掉的代码没删
- 部分功能没实现完(比如 RopeController 里的粒子拖拽)
- 缺少错误处理
- 代码注释不够
...
- 邮箱: 3484773855@qq.com

**反馈:**

- 如果发现bug或有建议,欢迎提 [Issues](https://github.com/JunMoChang/AncientPhysics/issues)
